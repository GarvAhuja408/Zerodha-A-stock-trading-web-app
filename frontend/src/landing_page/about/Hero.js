    ...
    return (  
        <div className="container">
            ...
            <div className='row p-5'>
                <h1 className='fs-3 text-center mt-5 text-muted' >We pioneered the discount broking model in India.<br></br>
            ...
            <div className='row p-5 border-top mt-5 text-muted'>
                ...
                <div className='col-6 p-5'>
                    ...
                    <p>
                     ...
                     <p> <Link to="https://rainmatter.com/">Rainmatter</Link>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
